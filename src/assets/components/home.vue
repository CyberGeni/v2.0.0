        ...
        <main class="md:h-fit">
            <div class="flex flex-wrap justify-around grow sm:justify-evenly sm:content-center sm:min-h-[75vh]">
                ...
                <div class="max-w-[420px] md:max-w-[550px]">
                    ...
                    <h2 class="see-more flex items-center text-2xl sm:text-3xl ">Learn more about me <router-link class="flex items-center justify-center border rounded-full ml-2 w-9 h-9" to="/about" exact><img class="mx-1 p-0.5 " src="src/assets/images/arrow-right.svg" alt="Arrow right button"></router-link></h2>
                </div>
            </div>
        </main>
    </div>
